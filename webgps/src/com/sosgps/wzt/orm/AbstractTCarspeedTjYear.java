...
/**
 * AbstractTCarspeedTjYear generated by MyEclipse Persistence Tools
 */

public abstract class AbstractTCarspeedTjYear implements java.io.Serializable {
	...
	/** default constructor */
	public AbstractTCarspeedTjYear() {
	}

	/** minimal constructor */
	public AbstractTCarspeedTjYear(Long id) {
		this.id = id;
	}

	/** full constructor */
	public AbstractTCarspeedTjYear(Long id, String deviceId, Double low4T,
