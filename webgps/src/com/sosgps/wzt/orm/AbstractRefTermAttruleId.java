...
/**
 * AbstractRefTermAttruleId entity provides the base persistence definition of
 * the RefTermAttruleId entity.
 * 
 * @author MyEclipse Persistence Tools
 */

public abstract class AbstractRefTermAttruleId implements java.io.Serializable {
	...
	/** default constructor */
	public AbstractRefTermAttruleId() {
	}

	/** full constructor */
	public AbstractRefTermAttruleId(TTerminal TTerminal,
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof AbstractRefTermAttruleId))
			return false;
		AbstractRefTermAttruleId castOther = (AbstractRefTermAttruleId) other;
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getTAttendanceRule() == null ? 0 : this.getTAttendanceRule()
						.hashCode());
		return result;
	}
