...
//  //sosgps.qxt.api.ResponseType rt = sosgps.qxt.api.QXTSend.sendGBK()
//  sosgps.qxt.api.ResponseType rt=sosgps.qxt.api.QXTSend.sendGBK(this.terminalParam.getSmsUser(),this.terminalParam.getSmsPassword(),null,null,null,simCard,cmd);
...
//  String[] simCard= {this.terminalParam.getSimCard()};
//  sosgps.qxt.api.ResponseType rt=sosgps.qxt.api.QXTSend.sendASCII(this.terminalParam.getSmsUser(),this.terminalParam.getSmsPassword(),null,null,null,simCard,cmd);
//  Log.getInstance().outLog("短信发送消息:企业："+this.terminalParam.getSmsUser()+" 密码:"+ this.terminalParam.getSmsPassword()+","+"内容:"+cmd+" 发送状态:"+rt.getCode());
//   return (rt.getCode()==0)?"true":"false";
//}
