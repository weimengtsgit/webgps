...
public class PagedRS_notitle extends Object {
	private static Log log = LogFactory.getLog(PagedRS_notitle.class);
	private ConnectService connectService;
	public PagedRS_notitle() //construct function
	{
	}
	...
	public int iPageSize = 999999999;
...
//	}
	...
	public String getHtmlViewTitle() {
		String sHtml = "<table width=100% border=0 cellspacing=0 cellpadding=2 align=center>"
				...
				//+ sCnFormName + "列表</td></tr><tr><td class=\"fullscreen\"><a href=\"#\" target=\"_blank\"> &nbsp; &nbsp;全屏显示</a></td>  </tr></table>";
		if (isPrint)
			sHtml = "<table width="
					+ sTotalWidth
