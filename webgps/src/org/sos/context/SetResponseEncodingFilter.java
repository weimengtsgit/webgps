 ...
 * @version $Revision: 1.1 $ $Date: 2011/11/28 07:32:39 $
 */

public class SetResponseEncodingFilter implements Filter {
	...
	public void doFilter(ServletRequest request, ServletResponse response,
		...
		// SetResponseEncodingWrapper wrapper = new
		// SetResponseEncodingWrapper(res);
		// chain.doFilter(request, wrapper);
		// res.setContentType("text/html; charset=" + encoding);
		// char[] responseChars = wrapper.toCharArray();
		// byte[] byteChars = new byte[responseChars.length];
		// for (int i = 0; i < responseChars.length; i++) {
		// byteChars[i] = (byte) responseChars[i];
		// }
		// String returnStr = new String(byteChars, encoding);
