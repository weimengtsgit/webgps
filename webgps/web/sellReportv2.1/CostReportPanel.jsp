...
<table id="costChartTable" width="100%" height="100%" border="0">
			<tr>
				...
				<input type="radio" name="costRadio" 
					onclick="javascript:selectFlag(true)" checked><span class="STYLE2">本<%=targetTemplateType%>费用额趋势图</span>				</td>
				<td width="89%" nowrap="nowrap">
				<input type="radio" name="costRadio" 
					onclick="javascript:selectFlag(false)">
					<span class="STYLE2">历史费用额趋势图</span>				</td>
				...
				<td width="89%" align="center" nowrap="nowrap">
					<a href="javascript:jumpToDetail()" class="STYLE4">点击查看明细</a>				</td>
			</tr>
			<tr>
