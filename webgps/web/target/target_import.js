    ...
    var form = new Ext.form.FormPanel({   
        ...
        items: [{
            ...
            handler: function(){
				...
				document.excelform.action = encodeURI(encodeURI(path + '/target/target.do?method=downloadTemplate&type='+typeValue+'&year='+year));
        ...
        buttons: [{   
            ...
            handler: function() {
                if(form.getForm().isValid()){
                    ...
                    form.getForm().submit({
                           url: path + '/target/target.do?method=uploadTarget&type='+typeValue+'&year='+year,
                           method:'post',
