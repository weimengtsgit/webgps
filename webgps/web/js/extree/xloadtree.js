...
function WebFXLoadTree(sText, sXmlSrc, sAction, sBehavior, sIcon, sOpenIcon, sId, sDesc, sExpend1, sExpend2, sExpend3, sExpend4, sExpend5, sExpend6) {
	// call super
...
function WebFXLoadTreeItem(sText, sXmlSrc, sAction, eParent, sIcon, sOpenIcon, sId, sDesc, sExpend1, sExpend2, sExpend3, sExpend4, sExpend5, sExpend6) {
	// call super
	this.WebFXTreeItem = WebFXTreeItem;
	this.WebFXTreeItem(sText, sAction, eParent, sIcon, sOpenIcon, sId, sDesc, sExpend1, sExpend2, sExpend3, sExpend4, sExpend5, sExpend6);
...
function _createNodeByType(type, oNode, parentDisabled, parentChecked){	
	if(type == "check"){
		jsNode = checkbox_createNode(oNode, parentDisabled, parentChecked);
	}else if(type == "radio"){
		jsNode = radio_createNode(oNode, parentDisabled, parentChecked);
	}else if(type == "normal"){
...
function _createNode(oNode){		
	...
	var jsNode;
	if (src != null && src != "")
		jsNode = new WebFXLoadTreeItem(text, src, action, parent, icon, openIcon, sId, sDesc, sExpend1, sExpend2, sExpend3, sExpend4, sExpend5, sExpend6);
	else
		jsNode = new WebFXTreeItem(text, action, parent, icon, openIcon, sId, sDesc, sExpend1, sExpend2, sExpend3, sExpend4, sExpend5, sExpend6);
