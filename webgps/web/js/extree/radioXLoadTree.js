...
function WebFXRadioLoadTree(sText, sXmlSrc, sAction, sBehavior, sIcon, sOpenIcon, sId, sDesc, sExpend1, sExpend2, sExpend3, sExpend4, sExpend5, sExpend6) {
	// call super
...
function WebFXLoadRadioTreeItem(sText, sValue, sXmlSrc, eParent, sIcon, sOpenIcon, bChecked, disabled, sId, sDesc, sExpend1, sExpend2, sExpend3, sExpend4, sExpend5, sExpend6) {
	// call super	
...
function radio_createNode(oNode, parentDisabled, parentChecked) {	
	// retreive attributes
	...
	var jsNode;
	if (src != null && src != "")
		jsNode = new WebFXLoadRadioTreeItem(text, value, src, parent, icon, openIcon, checked, disabled, sId, sDesc, sExpend1, sExpend2, sExpend3);
	else{
		jsNode = new WebFXRadioTreeItem(text,value, parent, icon, openIcon, checked, disabled, sId, sDesc, sExpend1, sExpend2, sExpend3);	
    	if(action!=null){
