  ...
  function createyear(year,obj)//创建年份选择
    ...
    var oDiv;
      ...
      ystr+="<tr><td style='cursor:hand' onclick='createyear("+(year-16)+",myC_Top.cells[2])' align=center>上翻</td></tr>";
      ...
      ystr+="<tr><td style='cursor:hand' onclick='createyear("+(year+16)+",myC_Top.cells[2])' align=center>下翻</td></tr>";
      ystr+="</table>";
