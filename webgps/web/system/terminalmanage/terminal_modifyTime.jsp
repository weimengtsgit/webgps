...
<head>
  <title></title>
    ...
    <link rel="stylesheet" type="text/css" href="<%=path%>/ext-3.1.1/examples/ux/Ext.ux.IconCombo.css">
    ...
    <script type="text/javascript" src="<%=path%>/ext-3.1.1/examples/ux/Ext.ux.IconCombo.js"></script>
	...
	<script type="text/javascript" src="<%=path%>/system/terminalmanage/terminalmodifyTime.js"></script>
