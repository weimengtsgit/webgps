	...
	handler: function(){
		...
		Ext.MessageBox.confirm('提示', '您确定要修改数据吗?', function (btn){
			if(btn=='yes'){
				...
				Ext.Ajax.request({
					url:path+'/vehiclesMaintenance/vehiclesMaintenance.do?method=updateVehiclesMaintenance',
					method :'POST', 
					params:{
						id: tmpid, deviceId: tmpdeviceId, maintenanceDate: tmpmaintenanceDate , expenses: tmpexpenses ,
...
var sm = new Ext.grid.RowSelectionModel({
	...
	listeners: {
		rowselect: function(sm, row, rec) {
			...
			Ext.getCmp('frmmaintenanceDate').setValue(rec.get('maintenanceDate'));
