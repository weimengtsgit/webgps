...
var proxy = new Ext.data.HttpProxy({
    url: path+'/log/loginlog.do?method=listLoginLog'
});
...
var grid = new Ext.grid.GridPanel({
    ...
    columns: [
            ...
            {header: '操作时间', width: 130, sortable: true, dataIndex: 'loginTime'},
        ...
        new Ext.form.Label({
	        ...
	        handler: function(){
    			...
    			document.excelform.action = path+'/log/loginlog.do?method=listLoginLog&'+tmpparam;
