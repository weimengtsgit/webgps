...
**/
        var addbut = new Ext.Action({
		        ...
		        handler: function(){
		            ...
		            parent.Ext.MessageBox.confirm('提示', '您确定要修改权限吗?', addConfirm);
		        },
		        iconCls: 'icon-modify'
		    });
...
function add(){
	...
	Ext.Ajax.request({
		 //url :url,
		 url:path+'/system/module.do?method=updateModule' ,
		 method :'POST', 
		 params: { moduleName: encodeURI(tmpfrmModuleName), moduleDesc: encodeURI(tmpfrmModuleDesc), moduleId: tmpfrmParentModuleId , moduleCode : encodeURI(tmpfrmModuleCode) ,modulePath : encodeURI(tmpfrmModuleUrl) ,gradeId : tmpfrmModuleGrade },
		 //timeout : 10000,
