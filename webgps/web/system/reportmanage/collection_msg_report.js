...
var VehicleMsgStatStore = new Ext.data.Store({
	restful: true,
	proxy: new Ext.data.HttpProxy({url: path+'/locate/locate.do?method=listLastLoc2'}),
	...
	tbar : {
		...
		items:[
			...
			{xtype: 'button',text: '导出Excel',iconCls: 'icon-excel',handler: function(){
				Ext.Ajax.request({
					method : 'POST',
					url: path+'/locate/locate.do?method=listLastLoc2&expExcel=true&start=0&limit=65535&deviceIds='+vehicleMsgStatDeviceids,
