  ...
  <tr>
    <td>
		<table  width="100%" border="0" cellspacing="1" cellpadding="1">
		      ...
		      <tr bgcolor="#FFFFFF">
		      	<td bgcolor="#eeeeee" colspan="2" >查找 <%=username %> </td>
		 		<input type="hidden" name="param2" value="<%=x %>"/>
		 		<input type="hidden" name="param3" value="<%=y %>"/>
		      </tr>
		      <tr bgcolor="#FFFFFF"><td bgcolor="#eeeeee">周边</td><td><input id="param5" name="param5" type="text" value="1000" style="width:110px" onKeyPress="inputNumberOnly()">米</td></tr>
		      <tr bgcolor="#FFFFFF"><td bgcolor="#eeeeee">的</td><td><input id="param4" name="param4" type="text"  style="width:110px" value=""><font class="bitian">*必填</font><font class="huixian"> 如:银行</font></td></tr>
