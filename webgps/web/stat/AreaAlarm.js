...
var proxy = new Ext.data.HttpProxy({
    url: path+'/stat/alarmStat.do?method=listAreaAlarm'
});
...
var grid = new Ext.grid.GridPanel({
    ...
    columns: [
            ...
            {header: '区域', width: 100, sortable: true, dataIndex: 'areaPoints',hidden:true},
            //{header: '开始时间', width: 130, sortable: true, dataIndex: 'startTime'},
