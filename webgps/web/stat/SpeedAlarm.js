...
var proxy = new Ext.data.HttpProxy({
    url: path+'/stat/alarmStat.do?method=listSpeedAlarm'
});
...
var grid = new Ext.grid.GridPanel({
    ...
    columns: [
            ...
            {header: '速度', width: 100, sortable: true, dataIndex: 'speed'},
            {header: '速度阀值', width: 100, sortable: true, dataIndex: 'speedLimit'},
