...
public class HQ20TerminalSetting extends TerminalSettingAdaptor {
  ...
  public HQ20TerminalSetting(com.autonavi.directl.idirectl.TerminalParam tparam) {
  ...
  /**
   * 设置连接GPRS最大时间
   * @param DDDD:最大连接时间 时间单位为秒，不能小于10，大于3600。
   * @return
   */
...
//   return this.sent(cmdStr);
   ...
   * @param degree String --- 次数
   * @return String
   */
  public String setLocatorIntervalTimeAndDegree(String intervalTime, String degree) {
    //十进制到十六进制转换
