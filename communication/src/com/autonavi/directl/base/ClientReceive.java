 ...
 * <p>Title: GPS网关</p>
 *
 * <p>Description:接收网关接收到的client指令 </p>
 *
...
public class ClientReceive {
  ...
  public String parseAndDeal(String requestID,String simcard,String[] params) {
    ...
    try {
      ...
      com.autonavi.directl.Log.getInstance().errorLog("读取gpsfuncmapping.xml异常：",ex);
    } catch (IOException e) {
		// TODO 自动生成 catch 块
		e.printStackTrace();
	}  
      ...
      if(!id.equalsIgnoreCase(requestID)){
        ...
        while(it.hasNext()){
          ...
          try {
            ...
            com.autonavi.directl.Log.getInstance().errorLog("ClientReceive反射类型"+classname+"异常：",ex1);
          }
        }
        try {
          ...
          //Constructor con = f.getConstructor(new Class[]{TerminalParam.class});
          //Object o = con.newInstance(new Object[]{t.getTerminalParam()});
          Object r = m.invoke(oo, params);
          if(r!=null)
            resultCmd = r.toString();
        }
        catch (Exception ex2) {
          Log.getInstance().errorLog("ClientReceive异常：",ex2);
          return null;
        }
      }
    }
  ...
  public BaseDictate parseAndDeal2(String requestID,String simcard,String[] params) {
    ...
    try {
      ...
      Log.getInstance().errorLog("读取gpsfuncmapping.xml异常：",ex);
    } catch (IOException e) {
		// TODO 自动生成 catch 块
		e.printStackTrace();
	}  
      ...
      if(!id.equalsIgnoreCase(requestID)){
        ...
        while(it.hasNext()){
          ...
          try {
            ...
            Log.getInstance().errorLog("ClientReceive反射类型"+classname+"异常：",ex1);
          }
        }
        try {
          TerminalFactory tf = new TerminalFactory();
  ...
  public static void main(String[] args){
    ...
    String simcard = "13401035046";
    String[] params = new String[3];
    params[0] = "60.28.28.22";
    params[1] = "7001";
    params[2] = "1111";//*/
    ///**
