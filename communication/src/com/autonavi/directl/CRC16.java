...
public class CRC16 {
	...
	static int[] auchCRCHi = { 0x00, 0xC1, 0x81, 0x40, 0x01, 0xC0, 0x80, 0x41,
	...
	/* CRC低位字节值表 */
	static int[] auchCRCLo = { 0x00, 0xC0, 0xC1, 0x01, 0xC3, 0x03, 0x02, 0xC2,
	...
	public static String CRC16(byte[] puchMsg) {
		int uchCRCHi = 0xFF;
		int uchCRCLo = 0xFF;
		int uIndex;
		int i = 0;
		while (i < puchMsg.length) {
			uIndex = (uchCRCHi) ^ (puchMsg[i] & 0xff);
			uchCRCHi = (uchCRCLo) ^ auchCRCHi[uIndex];
			uchCRCLo = auchCRCLo[uIndex];
			i = i + 1;
		}
		int resu =  (uchCRCHi << 8 | uchCRCLo);
		String ret = Tools.int2Hexstring(resu, 4);
		return ret;
	...
	public static void main(String[] args) {
		...
		byte[] b = Tools
				.fromHexString("2626");
		byte[] bb = Tools
				.str2Bcd("26261385596747402078da63606060606a6364609a010003540124");
		//System.out.println("" + Integer.toHexString(t.CRC16(b)));
	}
